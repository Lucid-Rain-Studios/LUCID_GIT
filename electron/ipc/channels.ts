export const CHANNELS = {
  ...
  GIT_MERGE:         'git:merge',
  GIT_MERGE_CONFLICT_DETAILS: 'git:merge-conflict-details',
  GIT_MERGE_CONFLICT_RESOLVE_TEXT: 'git:merge-conflict-resolve-text',
  GIT_MERGE_CONFLICT_FINALIZE: 'git:merge-conflict-finalize',
